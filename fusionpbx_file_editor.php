...
define('MAIN_DIR',/* __DIR__ */'/var/www/fusionpbx/');
...
define('PATTERN_FILES', '/^[A-Za-z0-9-_.\/]*\.(txt|php|htm|html|js|css|tpl|md|xml|json|lua|png|env)$/i'); // empty means no pattern
