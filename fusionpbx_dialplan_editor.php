...
define('MAIN_DIR', '/var/www/fusionpbx/app/dialplans/resources/switch/conf/');
...
define('PATTERN_FILES', '/^[A-Za-z0-9-_.\/]*\.(xml)$/i'); // empty means no pattern
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row p-3">
			<div class="col-md-3">
				<h1><a href="http://github.com/hamidsamak/pheditor" target="_blank" title="Pheditor <?= VERSION ?>">Pheditor: /usr/share/freeswitch/ </a></h1>
			</div>
			<div class="col-md-9">
