...
define('MAIN_DIR', '/etc/fusionpbx/resources/templates/provision/');
...
define('PATTERN_FILES', '/^[A-Za-z0-9-_.\/]*\.(xml|boot|cfg|txt)$/i'); // empty means no pattern
define('PATTERN_DIRECTORIES', '/^((?!backup).)*$/i'); // empy means no pattern
define('TERMINAL_COMMANDS', 'ls,ll,cp,rm,mv,whoami,pidof,pwd,whereis,kill,php,date,cd,mkdir,chmod,chown,rmdir,touch,cat,git,find,grep,echo,tar,zip,unzip,whatis,composer,help,node,tail');
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row p-3">
			<div class="col-md-3">
				<h1><a href="http://github.com/hamidsamak/pheditor" target="_blank" title="Pheditor <?= VERSION ?>">Pheditor: /etc/fusionpbx/resources/templates/provision/ </a></h1>
			</div>
			<div class="col-md-9">
