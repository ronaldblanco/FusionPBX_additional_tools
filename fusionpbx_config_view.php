...
define('MAIN_DIR',/* __DIR__ */'/etc/freeswitch/');
...
define('PATTERN_FILES', '/^[A-Za-z0-9-_.\/]*\.(txt|php|js|css|tpl|md|xml|json|lua|png)$/i'); // empty means no pattern
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row p-3">
			<div class="col-md-3">
				<h1><a href="http://github.com/hamidsamak/pheditor" target="_blank" title="Pheditor <?= VERSION ?>">Pheditor: /etc/freeswitch/</a></h1>
			</div>
			<div class="col-md-9">
